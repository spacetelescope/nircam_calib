...
class Throughput:
    ...
    def get_qe_curve(self,channel,module,wavelength):
        ...
        if channel == 'LW':
            if module == 'a':
                qe = lw_coeffs_a[0] + lw_coeffs_a[1]*wavelength + lw_coeffs_a[2]*wavelength**2 + lw_coeffs_a[3]*wavelength**3 + lw_coeffs_a[4]*wavelength**4 + lw_coeffs_a[5]*wavelength**5 + lw_coeffs_a[6]*wavelength**6
            if module == 'b':
